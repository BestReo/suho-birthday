...
다른 편지도 있어 👀`,
  ...
  // ----------------------------------------------------------
  //  🧱 수호 벽돌깨기 — 한 판에 사진 N장 공개하면 🎬 성장 영상
  // ----------------------------------------------------------
  bricksTarget: 3,
  filmTitle: '{이름}의 11년',
  filmYears: '2015 — 2026',
  filmChapters: [            // at = 앨범 사진 번호(0부터)에서 챕터 시작
    { at: 0, title: 'Chapter 1', sub: '아기 {이름}' },
    { at: 4, title: 'Chapter 2', sub: '개구쟁이 시절' },
    { at: 10, title: 'Chapter 3', sub: '지금의 {이름}' },
  ],
  filmEnd: ['태어나줘서 고마워', '11번째 생일 축하해, {이름아} 🎂', 'from. 준우'],

  // ----------------------------------------------------------
  //  🎹 생일 피아노 타일 — 타일 수에 따라 🏆 트로피
  // ----------------------------------------------------------
  pianoTrophies: [
    { at: 25, name: '동상', key: 'bronze' },
    { at: 50, name: '은상', key: 'silver' },
    { at: 100, name: '금상', key: 'gold' },
  ],
  trophyDate: '2026-09-19',
};
